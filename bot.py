...
async def help_message(ctx):
    ...
    embed = discord.Embed(title="Help", color=65280)\
        ...
        .add_field(name="b!list [Part Type] [Part Name <= 20 characters] [0 < List Price < 10000]", value="List a part for sale. This must have an attached image to use for the part. Bases must be 15 x 3. Trunks must be 15 x 12. Leaves must be 15 x 12.", inline=False)\
